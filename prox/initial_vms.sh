...
qm create 150 --name Kali --cdrom local:iso/kali-linux-2023.1-installer-amd64.iso --scsi0 VM-Main:64 --ostype l26 --memory 8192 --sockets 1 --cores 4 --net0 virtio=CE:A6:1A:16:FD:15,bridge=vmbr0,firewall=0 --net1 virtio=76:D3:BA:30:24:15,bridge=vmbr1,firewall=0 --netdev hostname=MtGagazet.spira.lan&
