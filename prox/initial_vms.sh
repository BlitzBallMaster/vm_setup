...
#qm create 100 &
qm create 150 --name Kali --cdrom local:iso/kali-linux-2022.4-installer-amd64.iso --scsi0 VM-Main:64 --ostype l26 --memory 8192 --sockets 1 --cores 4 --net0 virtio,bridge=vmbr0,firewall=0 --net1 virtio,bridge=vmbr1,firewall0&
#qm create 151 &
#qm create 152 &
#qm create 201 &
#qm create 202 &
